...
<body>
    ...
    <div class="container">
        ...
        <a href="<%=request.getContextPath()%>/mvc/employes/creer" class="btn btn-info" role="button" style="margin-bottom:2%;margin-left:87%;">Ajouter un employé</a>
        ...
        <table class="table table-hover table-bordered">
            ...
            <tbody>
            <c:forEach var="remEmp" items="${listRem}">
                <tr>
                    <td>${remEmp.dateHeureCreation }</td>
                    <td>${remEmp.matricule}</td>
                    <td>${remEmp.grade.code}</td>
                </tr>
                </c:forEach>
            </tbody>
        </table>
